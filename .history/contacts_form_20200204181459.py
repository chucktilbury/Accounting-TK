...
class ContactsForm:# (SetupDialog):
    ...
    def __init__(self, frame):
        ...
        col += 1
        tk.Entry(frame, textvariable=self.name, width=width).grid(
                                        columnspan=3, row=row, column=col, padx=padx, pady=pady, sticky=tk.W)
        ...
        col+= 1
        tk.Entry(frame, textvariable=self.address1, width=width).grid(
        ...
        col += 1
        tk.Entry(frame, textvariable=self.address2, width=width).grid(
                                        row=row, column=col, padx=padx, pady=pady, columnspan=3, sticky=tk.W)
